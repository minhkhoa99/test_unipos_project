        ...
        <div className="row">
          ...
          <div className="col-10-bottom">
            <div className="title-bottom">
              ...
              <p>Hệ thống hỗ trợ</p>
              <p>Hỗ trợ triển khai cho các tổ chức lớn</p>
              <p>Bảo vệ</p>
            ...
            <div className="title-bottom">
              ...
              <p>Theo chủ đề</p>
              <p>Nghành nghề</p>
              <h3>Theo quy mô công ty</h3>
              <h3>Thông tin hữu ích</h3>
              <p>Tài liệu hữu ích</p>
            ...
            <div className="title-bottom">
              ...
              <p>Hệ thông / phát triển nguồn nhân lực</p>
              <p>Sự quản lý</p>
