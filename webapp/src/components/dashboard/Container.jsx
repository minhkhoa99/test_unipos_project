      ...
      <div className='container__content'>
        ...
        <section className='section section--bgGray'>
          ...
          <div className='what'>
            <div className='what__textContainer'>
              <p className='what__description'>
                ...
                <font>
                  <font>
                    Những trải nghiệm tích cực về lòng biết ơn, sự ngưỡng mộ và
                    những phần thưởng cảm xúc làm <br />
                    tăng sự
                  </font>
                </font>
                <br />
                ...
                <font>
                  <font>tổ chức và tạo ra một tổ chức vững mạnh.</font>
                </font>
              </p>
              <div className='peerbonus'>
                <div className='peerbonus__textContainer'>
                  ...
                  <p className='peerbonus__subTitle'>
                    <font>
                      <font>“Đồng đẳng + Tiền thưởng”</font>
                    </font>
                  </p>
                </div>
                <p className='peerbonus__description'>
                  <font>
                    <font>
                      Một hệ thống trong đó các nhân viên gửi “tin nhắn khen
                      ngợi vì những đóng góp của họ” và “những phần thưởng nhỏ”
                      cho nhau.
                    </font>
                    <font>
                      Những đóng góp mà người quản lý và các phòng ban khác
                      không thấy được sẽ trở nên hữu hình, và chu kỳ đánh giá và
                      khen ngợi tích cực trở thành một thói quen.
                    </font>
                  </font>
                </p>
              </div>
              <p className='what__annotation'>
                ...
                <font>
                  <font>
                    {" "}
                    Tiền thưởng ngang hàng là nhãn hiệu đã đăng ký của Rating
                    App
                  </font>
                </font>
              </p>
          ...
          <div className='banner'>
            <img className='what__image' src={banner} alt='' />
          </div>
        </section>
      </div>
    </>
