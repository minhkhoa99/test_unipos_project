(function (global, factory) {
	...
	(factory((global.ReactReduxContext = {}),global.React,global.Redux));
	...
	*/
	...
	var Provider = function (_React$Component) {
	  ...
	  function Provider(props) {
	    ...
	    _this._actions = redux.bindActionCreators(_this.props.actions, _this.props.store.dispatch);
	...
	var ProviderLens = function ProviderLens(_ref) {
	  ...
	  return React.createElement(
	    ...
	    function (storeData) {
	      ...
	      var mergedStoreData = deepmerge_1(storeData, dataToMerge, { clone: false });
	...
	function connect(mapStateLensToProps, mapActionsLensToProps, mergeProps) {
	  ...
	  return function (WrappedComponent) {
	    var ConnectedComponent = function (_React$Component) {
	      inherits(ConnectedComponent, _React$Component);
